...
<head>
	...
	<link rel="stylesheet" href="res/css/pass-style.css">
</head>
<body>
    <div class="container">
            ...
            <div class="signin-right">
                <form method="post">
                    <div class="input-container">
                        <input type="password" id="password" placeholder=" " required name="password" autofocus>
                    ...
                    <div class="button-group">
                        <button class="create-account">Forgot password?</button>
